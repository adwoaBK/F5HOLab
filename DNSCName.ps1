$CNAME= "1aabc-wingtiptoyssite.msappproxy.net"
$name="1abc"                                  
...
$type="CNAME"                                    # Record type A, CNAME, MX, etc.
...
$Request = @(@{data=$CNAME;port=$port;priority=0;protocol="string";service="string";ttl=$ttl;weight=$weight })
